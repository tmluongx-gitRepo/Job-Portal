...
async def create_job(job_data: dict, posted_by: Optional[str] = None) -> dict:
    """
...
async def get_job_by_id(job_id: str, increment_views: bool = False) -> Optional[dict]:
    """
    Get a job by ID.
...
async def get_jobs_count(is_active: Optional[bool] = None, posted_by: Optional[str] = None) -> int:
    """
