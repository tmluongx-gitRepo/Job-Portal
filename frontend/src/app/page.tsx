...
export default function Home(): ReactElement {
  const featuredJobs = [
    {
      ...
      description:
        "Lead regenerative practices that heal communities while growing sustainable business solutions...",
    ...
    },
    {
      ...
      salary: "$95k - $120k",
      description:
        "Build technology that empowers communities and creates equitable access to digital resources...",
    ...
    },
    {
      ...
      salary: "$105k - $135k",
      description:
        "Design business models that thrive by giving back more than they take from the world...",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-amber-50 to-green-100">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-green-700 mb-8 max-w-3xl mx-auto leading-relaxed">
              <em>Work in harmony:</em> Find careers that honor your whole
              self—where you don&apos;t have to sacrifice your wellbeing,
              values, or dignity just to make a living.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-3xl mx-auto">
              <div className="text-center">
                ...
                <div className="text-sm text-green-500">
                  *Real humans creating real change
                </div>
              </div>
              <div className="text-center">
      ...
      <section
        id="solutions"
        className="py-16 bg-gradient-to-r from-green-50 to-amber-50"
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-green-900 mb-4">
            ...
            <p className="text-green-700 text-xl">
              (Growing people and community together)
            </p>
          </div>
      ...
      <section className="py-16 bg-gradient-to-r from-green-800 to-green-900">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl text-green-100 mb-8 leading-relaxed">
            Join a community of professionals cultivating meaningful work that
            nurtures people, communities, and our planet.
          </p>
          <p className="text-green-200 mb-8">
            <em>
              (Side effects may include: deep fulfillment, authentic
              relationships, and helping heal the world)
            </em>
          </p>
