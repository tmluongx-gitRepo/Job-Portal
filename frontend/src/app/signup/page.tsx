...
export default function SignupPage(): ReactElement {
  ...
  const handleSubmit = async (e?: React.FormEvent): Promise<void> => {
    ...
    try {
      ...
      if (
        "email_confirmation_required" in response &&
      ...
      if (apiError.status === 400) {
        ...
        const errorDetail =
          (errorData?.detail ? String(errorData.detail) : apiError.message) ||
          "";
        ...
        // Check if it's an email validation error
          ...
          (errorLower.includes("invalid") || errorLower.includes("value error"))
        ) {
          errorMessage =
            "Please enter a valid email address. Some email formats (like aliases with +) may not be supported.";
        }
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleCompanyProfileChange("company_name", e.target.value)
                    }
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <select
                      ...
                      className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-green-400 focus:border-transparent bg-white/80 transition-all ${
                        errors.industry ? "border-red-500" : "border-green-300"
                      }`}
                      required
                    >
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        handleCompanyProfileChange("location", e.target.value)
                      }
                      placeholder="City, State"
                      className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-green-400 focus:border-transparent bg-white/80 transition-all ${
                        errors.location ? "border-red-500" : "border-green-300"
                      }`}
                      required
                    />
                    {errors.location && (
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        handleCompanyProfileChange("job_title", e.target.value)
                      }
                      placeholder="e.g., HR Manager, Recruiter"
                      className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-green-400 focus:border-transparent bg-white/80 transition-all ${
                        errors.job_title ? "border-red-500" : "border-green-300"
                      }`}
                      required
                    />
                    {errors.job_title && (
