...
import { 
  Leaf, Search, User, MapPin, Clock, Building2, Briefcase, GraduationCap, 
  Star, ChevronDown, ArrowLeft, Mail, Phone, Eye, Download, Calendar, MoreVertical 
} from 'lucide-react';
...
function StatusDropdown({ applicant, isOpen, onToggle, onUpdateStatus }: StatusDropdownProps) {
...
export default function ApplicationsPage() {
  ...
  const [openStatusDropdowns, setOpenStatusDropdowns] = useState<Set<number>>(new Set());
    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-amber-50 to-green-100">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex items-center space-x-2 mb-6">
          <Link href="/jobs" className="text-green-600 hover:text-green-800 flex items-center">
                      ...
                      <div className="flex items-start justify-between">
                        ...
                        <div className="flex items-center space-x-2 ml-2">
                          <StatusDropdown 
                            ...
                            onUpdateStatus={(newStatus) => updateApplicantStatus(applicant.id, newStatus)}
                          />
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-6 text-xs sm:text-sm text-green-600 mb-3">
                      ...
                      <span className="text-xs text-gray-500 whitespace-nowrap">
                        Applied {(() => {
                          const date = new Date(applicant.appliedDate + 'T00:00:00');
